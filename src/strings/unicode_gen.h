...
#define num_unicode_property_value_keypairs 3712
...
typedef enum {
    ...
    MVM_UNICODE_PROPERTY_JAMO_SHORT_NAME = 16,
    MVM_UNICODE_PROPERTY_LINE_BREAK = 17,
    MVM_UNICODE_PROPERTY_CANONICAL_COMBINING_CLASS = 18,
    ...
    MVM_UNICODE_PROPERTY_EAST_ASIAN_WIDTH = 27,
    MVM_UNICODE_PROPERTY_JOINING_TYPE = 28,
    MVM_UNICODE_PROPERTY_NFG_QC = 29,
    MVM_UNICODE_PROPERTY_BIDI_PAIRED_BRACKET_TYPE = 30,
    MVM_UNICODE_PROPERTY_NFC_QC = 31,
    MVM_UNICODE_PROPERTY_DIGIT = 32,
    MVM_UNICODE_PROPERTY_NFKC_QC = 33,
